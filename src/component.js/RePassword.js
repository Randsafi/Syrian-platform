...
import { Box, Button, Container, Stack, TextField, Grid, Typography, InputAdornment, IconButton, ThemeProvider } from "@mui/material";
        ...
        <Box sx={{ display:'flex',flexDirection:'column' , gap: 2, my: 3 }}>
          <Stack
           ...
           sx={{display:'flex',
              ...
              gap: 2, my: 3,
              direction:'rtl' }}>
            <Typography variant="h6" sx={{ mr: 3 ,marginLeft:'420px'  }}>كلمة المرور</Typography>
            <TextField
            ...
            />
            <Typography variant="h6" sx={{ mr: 3 ,marginLeft:'420px'  }}>تأكيد كلمة المرور</Typography>  
            <TextField
              id="outlined-password-input"
              placeholder=" ادخل كلمة السر"
